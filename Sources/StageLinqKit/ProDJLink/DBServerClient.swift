...
public struct DBServerMeta: Sendable {
    ...
    public static let empty = DBServerMeta(title: "", artist: "", key: "", genre: "", album: "", comment: "")
}
...
public final class DBServerClient {
    ...
    private static func fetchWaveform(ip: String, port: UInt16,
        ...
        guard (try? conn.send(buildGetWaveformPreview(txid: 1, slot: slot, trackID: trackID))) != nil
        else { return nil }
    ...
    private static func buildGetWaveformPreview(txid: UInt32, slot: UInt8, trackID: UInt32) -> Data {
    ...
    private static func parseResponse(_ data: Data) -> DBServerMeta {
        ...
        return DBServerMeta(title: title, artist: artist, key: key, genre: genre, album: album, comment: comment)
    }
